...
class student:
    ...
    @staticmethod #It is a static method used as a setter and getter for static cariable 
    def setCollegeName(newCollage):
        student.collageName = newCollage
